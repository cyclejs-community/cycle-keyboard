...
function main(_ref) {
  ...
  var keyDown$ = keyboard.down$.map(function (x) {
    return x.keyCode + ' keydown';
  });
  var keyPress$ = keyboard.press$.map(function (x) {
    return x.charCode + ' keypress';
  });
  var keyUp$ = keyboard.up$.map(function (x) {
    return x.keyCode + ' keyup';
  });
