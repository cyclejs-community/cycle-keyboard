...
[![npm version](https://img.shields.io/badge/npm-v1.0.0--rtm.3-orange.svg)](https://img.shields.io/badge/npm-v1.0.0--rtm.3-orange.svg)[![license](https://img.shields.io/badge/license-MIT-blue.svg)](https://img.shields.io/badge/license-MIT-blue.svg)

## Usage
Install the package using node package manager
```
$ npm install cycle-keyboard@1.0.0-rtm.3
```
